...
public class Level0 extends Level {
    ...
    private void generateMap2(){
        ...
        setRoomConnector(room10, "icrogue/level011", Level0Room.Level0Connectors.S, Connector.ICRogueConnectorState.OPEN);
        setRoomConnector(room10, "icrogue/level002", Level0Room.Level0Connectors.E, Connector.ICRogueConnectorState.OPEN);
        ...
        setRoomConnector(room20, "icrogue/level001", Level0Room.Level0Connectors.W, Connector.ICRogueConnectorState.OPEN);
        setRoomConnector(room20, "icrogue/level003", Level0Room.Level0Connectors.E, Connector.ICRogueConnectorState.OPEN);

        DiscreteCoordinates room30 = new DiscreteCoordinates(3,0);
        setRoom(room30, new Level0KeyRoom(room30, BOSS_KEY_ID));
        setRoomConnector(room30, "icrogue/level002", Level0Room.Level0Connectors.W, Connector.ICRogueConnectorState.OPEN);

        DiscreteCoordinates room11 = new DiscreteCoordinates(1, 1);
        setRoom (room11, new Level0Room(room11));
        setRoomConnector(room11, "icrogue/level001", Level0Room.Level0Connectors.N, Connector.ICRogueConnectorState.OPEN);
